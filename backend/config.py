...
class Settings(BaseSettings):
    ...
    # ALL defaults are now empty strings — operators explicitly opt-in to each
    # timeframe via Crypto Settings Flyout. Originally only BTC 5m / ETH 5m were
    # blank (Plan 0042); extended to ALL 16 series in Plan 0045 follow-up after
    # live evidence that non-5m series silently consumed Polymarket WS cap
    # slots even when no strategy subscribed to them. Known production IDs:
